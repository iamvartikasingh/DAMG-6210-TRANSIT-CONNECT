...
-- Customer User (Read-only + subscription + booking access)
...
-- Allow EXECUTE on procedures/packages
GRANT EXECUTE ON ADMIN.PURCHASE_SUBSCRIPTION TO app_customer_user;
GRANT EXECUTE ON ADMIN.TICKET_BOOKING_PKG TO app_customer_user;
...
GRANT EXECUTE ON ADMIN.TICKET_BOOKING_PKG TO app_txn_manager;
...
GRANT EXECUTE ON ADMIN.TICKET_BOOKING_PKG TO app_booking_mgr;
...
GRANT EXECUTE ON ADMIN.USER_REGISTRATION_PKG TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.GET_USER_DISCOUNT TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.VALIDATE_USER TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.GET_SUBSCRIPTION_TYPE_ID TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.GET_ACTIVE_SUBSCRIPTION TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.SUBSCRIPTION_PKG TO app_subs_mgr;
GRANT EXECUTE ON ADMIN.PURCHASE_SUBSCRIPTION TO app_subs_mgr;
